...
public class DBMemberPreviewActivity extends SubActivity {
    ...
    private ImageView mManagerSign;
    ...
    protected void onConfigrationTitleBar() {
        ...
        setTitleBarTitleText("预览");
    }
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.cheng_yuan_yu_lan);
        setupViews();
	...
	protected void setupViews() {
		// TODO Auto-generated method stub
        mUserSign = (ImageView)this.findViewById(R.id.user_sign);
        mManagerSign = (ImageView)this.findViewById(R.id.manager_sign);
		mAvatar = (ImageView)this.findViewById(R.id.avatar);
		mYearPhoto = (ImageView)this.findViewById(R.id.avatar_1);
        mTextName = (TextView)this.findViewById(R.id.id_name);
		mTextIdCard = (TextView)this.findViewById(R.id.text_id_card);
        mTextCYXB = (TextView)this.findViewById(R.id.preview_CYXB);
        mTextCYNL = (TextView)this.findViewById(R.id.preview_CYNL);
        mTextCYLDNL = (TextView)this.findViewById(R.id.preview_CYLDNL);
        mTextCYJKQK = (TextView)this.findViewById(R.id.preview_CYJKQK);
        mTextCYCJLB = (TextView)this.findViewById(R.id.preview_CYCJLB);
        mTextCYCJDJ = (TextView)this.findViewById(R.id.preview_CYCJDJ);
        mTextCYWHCD = (TextView)this.findViewById(R.id.preview_CYWHCD);
        mTextCYSFZX = (TextView)this.findViewById(R.id.preview_CYSFZX);
        mTextCYYSQRGX = (TextView)this.findViewById(R.id.preview_CYYSQRGX);
        mTextCYSFHCSFZ = (TextView)this.findViewById(R.id.preview_CYSFHCSFZ);
        mTextCYSFHCHKB = (TextView)this.findViewById(R.id.preview_CYSFHCHKB);
        //mAttachFrame = (LinearLayout)this.findViewById(R.id.attachments);
	}
	...
	private void updateViews() {
        ...
        if (mUserInfo.getIdNumber() != null) {
            ...
            mTextName.setText(mUserInfo.getName());
        ...
        if (mUserInfo.getManager_signture() != null)
            mManagerSign.setImageBitmap(mUserInfo.getManager_signture());

        if (mUserInfo.getUser_signture() != null)
            mUserSign.setImageBitmap(mUserInfo.getUser_signture());
