...
public class AttachmentChaKanActivity extends SubActivity implements OnClickListener, OnLongClickListener {
	...
	protected void onNewIntent(Intent intent) {
		...
		time = intent.getStringExtra(Const.KEY_TIME);
		if(userInfo != null) {
	...
	public void loadData() {
		// TODO Auto-generated method stub
		List<Attachment> attachs = DBHelper.getInstance().getAttachmentsByTime(userInfo.getCheck_task_id(), time);
