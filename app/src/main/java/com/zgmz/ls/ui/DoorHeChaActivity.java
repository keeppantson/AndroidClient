...
public class DoorHeChaActivity extends SubActivity implements OnClickListener, OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.door_he_cha);
        setupViews();
	}
	...
	protected void setupViews() {
        ...
        mBtnShuJuHeCha = (ImageButton)this.findViewById(R.id.yi_he_cha);
        mBtnShuJuXiaZai = (ImageButton)this.findViewById(R.id.wei_he_cha);
